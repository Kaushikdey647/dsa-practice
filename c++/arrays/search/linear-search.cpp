...
bool linearSearch(int* begin, int* end, int X){
...
int main()
{
    int arr1[] = {1,3,6,9,10,11,124,235,456,586,698,890,1342,3524,6346,5477,5688,6798,7809,23466};
    int arr2[] = {1,4,7,9,12,42,65,74,86,99,123,234,315,451,512,674,721,893,901};
    cout << "Array1" << endl;
    algoChecker(arr1,arr1+20,&linearSearch);
    cout << "Array2" << endl;
    algoChecker(arr2,arr2+19,&linearSearch);
}